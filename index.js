...
function getWinners(array,callback) {
    return callback(array).map(function(winner){ 
...
function getWinnersByYear(array,callback,callback1,callback2) {
 
    return callback(array,callback2).map((item,index) => `In ${callback(array,callback2)[index]}, ${callback1(array,callback2)[index]} won the world cup!`);
}
...
function getAverageGoals(array) {
   ...
   const homeAva=array.reduce(function(avg,value, _,{length}){

       return avg + value["Home Team Goals"] / length;

   },0);
   const awayAva=array.reduce(function(avg,value, _,{length}){

    return avg + value["Away Team Goals"] / length;

},0);
return (homeAva + awayAva).toFixed(2)+ ""
}
