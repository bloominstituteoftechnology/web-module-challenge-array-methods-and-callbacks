...
function getAverageGoals(data) {    
    ...
    let awayAverage = data.reduce((accumulator, item) => accumulator + item["Away Team Goals"], 0) / data.length;    return {homeAverage, awayAverage};};console.log(getAverageGoals(fifaData))
