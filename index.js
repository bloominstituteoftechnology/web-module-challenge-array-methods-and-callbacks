...
const fifaData2014 = fifaData.filter(function(item){
    return item.Year === 2014 && item.Stage === 'Final';
})
console.log('1:', fifaData2014);
//(a) Home Team name for 2014 world cup final
console.log('1a:', fifaData2014[0]['Home Team Name']);
//(b) Away Team name for 2014 world cup final
console.log('1b:', fifaData2014[0]['Away Team Name']);
//(c) Home Team goals for 2014 world cup final
console.log('1c:', fifaData2014[0]['Home Team Goals']);
//(d) Away Team goals for 2014 world cup final
console.log('1d:', fifaData2014[0]['Away Team Goals']);
//(e) Winner of 2014 world cup final */
console.log('1e:', fifaData2014[0]['Win conditions']);
...
function getWinnersByYear(fifadata, getFinalsCB, getYearsCB, getWinnersCB) {
   const winners = getWinners(fifadata, getFinals);
    ...
    const Final = getFinals(fifaData, getFinals)
