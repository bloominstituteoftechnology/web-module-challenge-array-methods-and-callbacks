...
var finals = fifaData.filter((item)=> {
...
function getFinals(fifaData) {
    finals = fifaData.filter(function (item) {
...
function getWinners(finals) {
    let winners = finals.map(function(item) {
      ...
      let winningTeam = item['Home Team Name'];
      if(awayGoals > homeGoals) {
        winningTeam = item['Away Team Name'];
      }
      return winningTeam;
    });
...
function getAverageGoals(finals) {
    let goalsPerMatch = finals.map(function(item){
      let homeGoals = item['Home Team Goals'];
      let awayGoals = item['Away Team Goals'];
