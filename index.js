...
const getFinals = fifaData.filter((score) => {
...
function getWinnersByYear(years, homeAway, index) {
    return `In ${years[index]}, ${homeAway[index]} won the world cup!`
}

console.log(getWinnersByYear(getYears, getWinners, 8));
